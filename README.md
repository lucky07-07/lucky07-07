...
class AnilKumar:
    def __init__(self):
        ...
        self.education   = "M.Sc. Data Science (in progress)"
        self.focus       = ["Deep Learning", "Computer Vision", "NLP", "Generative AI"]
        self.stack       = ["PyTorch", "Transformers", "FastAPI", "React", "Docker"]
        self.currently   = "Imbalance-aware vision transformers + low-resource NLP"
        self.philosophy  = "Research-grade rigor, production-grade delivery."

    def open_to(self):
        return ["AI / ML Internships", "Research Collaborations",
                "Open-Source AI", "Full-Stack AI Engineering Roles"]
```
...
```yaml
Research:
  - Imbalance-aware fine-grained vision (transformer ensembles, attention, TTA)
  - Low-resource & Indic NLP (Kannada, IndicTrans2, back-translation evaluation)
  - Real-time streaming AI (Kafka + PyTorch + STGCN)

Engineering:
  - Production-ready ML APIs (FastAPI + Docker)
  - Frontend dashboards for ML systems (React + Tailwind + Framer Motion)

Learning:
  - Generative AI · LLM fine-tuning · RAG · diffusion models
  - MLOps · model compression · on-device inference
```
